...
<template>
	<div class="first-screen">
		<div class="first-screen__container">
			<h1 class="first-screen__title">Генератор HTML форм</h1>
			<div class="first-screen__body">
				<div class="first-screen__column">
					<div class="first-screen__field">
						...
						<textarea name="upload-json-textarea" id="upload-json-textarea" v-model="schemaString"
					...
					<div class="first-screen__field">
						...
						<textarea name="reactive-form-data-textarea" id="reactive-form-data-textarea" readonly v-model="formDataString"
							class="first-screen__textarea"></textarea>
					</div>
				</div>
				<div class="first-screen__column">
